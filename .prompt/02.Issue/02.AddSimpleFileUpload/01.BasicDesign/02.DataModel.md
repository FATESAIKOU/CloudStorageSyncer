...
package "Service (Business Logic)" {
  class S3Service {
    ...
    +save_config(config: S3Config): None
  }
}
...
class UploadResult:
    ...
    @classmethod
    def success_result(cls) -> 'UploadResult':
        """建立成功結果"""
        return cls(success=True)

    @classmethod
    def error_result(cls, error_message: str) -> 'UploadResult':
        """建立錯誤結果"""
