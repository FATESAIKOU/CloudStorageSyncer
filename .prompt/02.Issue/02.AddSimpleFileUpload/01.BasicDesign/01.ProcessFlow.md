...
### 3.3 List and Search Commands
```bash
# List files in S3 bucket
cloud-storage-syncer list files

# List files with detailed information
cloud-storage-syncer list files --details

# List files with prefix filter
cloud-storage-syncer list files --prefix "uploads/"

# Show storage class summary
cloud-storage-syncer list storage-summary

# Search files by pattern
cloud-storage-syncer list search "pattern"
```
