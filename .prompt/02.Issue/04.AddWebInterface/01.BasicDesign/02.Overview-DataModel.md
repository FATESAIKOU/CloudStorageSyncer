...
classDiagram
    ...
    class AuthCredentials {
        ...
        +password: string
        +validate(): bool
        +is_valid_hardcoded(): bool
    }

    class AuthConfig {
        +HARDCODED_USERNAME: string = "admin"
        +HARDCODED_PASSWORD: string = "cloudsyncer2025"
    ...
    class ApiErrorCode {
        +AUTH_REQUIRED: string = "AUTH_001"
        +INVALID_CREDENTIALS: string = "AUTH_002"
        +FILE_NOT_FOUND: string = "FILE_001"
        +UPLOAD_FAILED: string = "FILE_002"
        +DOWNLOAD_FAILED: string = "FILE_003"
        +DELETE_FAILED: string = "FILE_004"
        +S3_CONNECTION_ERROR: string = "S3_001"
        +INVALID_REQUEST: string = "REQ_001"
        +SERVER_ERROR: string = "SRV_001"
    }
